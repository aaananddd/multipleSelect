      ...
      <div className="relative block page flex">
        ...
        <div className="w-1/3 bg-gray-200 py-10 px-6 relative">
          ...
          <div>
            <br />
            <div>
              <h3 className="uppercase mb-2 font-semibold">Contact Details</h3>
        ...
        <div className="relative content-container ml-6 px-10 py-6 w-2/3">
          ...
          <h3 className="font-medium text-lg mb-2">Highest Qualification</h3>
          <p className="text-gray-700 mb-4">qualifictaion detaails here</p>
          ...
          <h3 className="font-medium text-lg mb-2">Additional Qualification</h3>
          <p className="text-gray-700 mb-4">addional qualifications here</p>

          <div className="uppercase text-gray-600 mt-12 mb-2">Experience</div>
